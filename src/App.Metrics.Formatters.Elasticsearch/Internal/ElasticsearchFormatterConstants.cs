...
namespace App.Metrics.Formatters.Elasticsearch.Internal
{
    public static class ElasticsearchFormatterConstants
    {
        ...
        {
            public static readonly Dictionary<HistogramValueDataKeys, string> CustomHistogramDataKeys =
                new Dictionary<HistogramValueDataKeys, string>
                {
                    {
            ...
            public static readonly Dictionary<MeterValueDataKeys, string> CustomMeterDataKeys =
                new Dictionary<MeterValueDataKeys, string>
                {
            ...
            public static readonly Func<string, string, string> MetricNameFormatter = (metricContext, metricName) =>
